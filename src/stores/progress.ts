...
export const useProgressStore = defineStore('progress', () => {
  ...
  const stages = [
    ...
    { lvl: 4, emoji: '🐛', title: 'Гусеница' },
    { lvl: 6, emoji: '🐢', title: 'Черепашка' },
    { lvl: 8, emoji: '🐿️', title: 'Лесная Белка' },
    { lvl: 10, emoji: '🦊', title: 'Хитрый Лис' },
    { lvl: 12, emoji: '🐒', title: 'Любопытная Обезьянка' },
    { lvl: 14, emoji: '🦉', title: 'Мудрая Сова' },
    { lvl: 16, emoji: '🐬', title: 'Умный Дельфин' },
    { lvl: 18, emoji: '🦌', title: 'Благородный Олень' },
    { lvl: 20, emoji: '🦅', title: 'Орёл-Сокол' },
    { lvl: 22, emoji: '🐺', title: 'Вожак Стаи' },
    { lvl: 24, emoji: '🦁', title: 'Молодой Лев' },
    { lvl: 26, emoji: '🦏', title: 'Сильный Носорог' },
    { lvl: 28, emoji: '🐘', title: 'Мудрый Слон' },
    { lvl: 30, emoji: '🦈', title: 'Повелитель Океана' },
    { lvl: 32, emoji: '🐅', title: 'Быстрый Тигр' },
    { lvl: 34, emoji: '🐉', title: 'Молодой Дракон' },
    { lvl: 36, emoji: '🦚', title: 'Великолепный Феникс' },
    { lvl: 38, emoji: '🦄', title: 'Волшебный Единорог' },
    { lvl: 40, emoji: '🐲', title: 'Древний Дракон' },
    { lvl: 42, emoji: '🦂', title: 'Скорпион-Защитник' },
    { lvl: 44, emoji: '🦇', title: 'Ночной Хранитель' },
    { lvl: 46, emoji: '🧜‍♂️', title: 'Повелитель Морей' },
    { lvl: 48, emoji: '🦍', title: 'Горный Гигант' },
    { lvl: 50, emoji: '🌟', title: 'Звездный Зверь' }
  ];

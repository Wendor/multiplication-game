...
export const useProgressStore = defineStore('progress', () => {
  ...
  const stages = [
    ...
    { lvl: 15, emoji: '🐬', title: 'Умный Дельфин' },
    { lvl: 20, emoji: '🦅', title: 'Орёл' },
    { lvl: 25, emoji: '🦁', title: 'Царь Зверей' },
    { lvl: 30, emoji: '🦏', title: 'Несокрушимый Носорог' },
    { lvl: 35, emoji: '🐲', title: 'Мудрый Дракон' },
    { lvl: 40, emoji: '🦚', title: 'Великолепный Павлин' },
    { lvl: 45, emoji: '🦄', title: 'Волшебный Единорог' }
  ];
